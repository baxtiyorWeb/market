...
const ProductGetList = () => {
  ...
  return (
    <div className="h-[80vh] overflow-scroll border">
      ...
      <div className="response_product_category relative grid grid-cols-4 gap-3 2xs:grid 2xs:grid-cols-2">
        {isLoading && (
              ...
              >
                ...
                <div className="relative h-[230px] overflow-hidden">
                  <div className="cart-slider group flex h-full items-center justify-center">
                    <button
                      className="absolute right-[20%] top-[40%] z-50 hidden rounded-3xl bg-bgColor px-3 py-2 text-white hover:border-bgColor hover:bg-bgColor/90 group-hover:block"
