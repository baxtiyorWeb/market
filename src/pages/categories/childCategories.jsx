    ...
    <Container>
      <div className="child-categ h-full  items-start justify-center lg:w-full xs:w-full 2xs:w-full 3xs:w-full ">
        <div className="mb-3 flex w-full items-center justify-start rounded-md  ">
          <div className="mt-3 sm:grid sm:grid-cols-4 md:grid md:grid-cols-2 lg:grid lg:grid-cols-3 lg_min_c:flex lg_min_c:border lg_min_c:border-none xs:grid xs:grid-cols-2">
            {categoryRoot?.map((item, index) => (
              <div
                className="flex items-center justify-center border 3xs:text-[13px]"
                key={index}
              >
                <Link
                  to={`/category/${item?.id}`}
          ...
          <div className="relative col-span-5 row-span-3 h-full">
            {
              <div className="flex justify-end px-5 lg:w-full">
                <button className="rounded-md border border-bgColor px-3 text-textColor hover:bg-bgColor hover:text-textColor">
                  filterni tozalash
                </button>
              </div>
            }
            <div className="lg:w-full">
              ...
              />
              <div className="my-5 grid h-auto grid-cols-4 items-center justify-between gap-3 rounded-md bg-white text-left text-[15px] md:hidden md:max-w-full lg:hidden">
                <Select
                  className=" w-[230px]"
                  onChange={(e) => {
