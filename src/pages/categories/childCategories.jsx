    ...
    <Container>
      <div className="child-categ h-full  items-start justify-center lg:w-full xs:w-full 2xs:w-full 3xs:w-full ">
        <div className="mb-3 flex w-full items-center justify-start rounded-md  ">
          <div className="mt-3 sm:grid sm:grid-cols-4 lg_min_c:flex lg_min_c:border lg_min_c:border-none md:grid md:grid-cols-2 lg:grid lg:grid-cols-3 xs:grid xs:grid-cols-2">
