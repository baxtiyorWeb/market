          ...
          data?.data?.data?.content?.map((item, index) => (
            ...
            >
              <div className="relative h-[194px]  overflow-hidden">
                <div
                  className="cart-slider flex h-full  items-center justify-center"
                  key={index}
                >
                  <Link
              ...
              <div className="mt-4 px-[18px]">
                <span className="text line-clamp-1 font-poppins text-[16px] font-medium not-italic leading-[120%] tracking-[-0.32px] text-textColor">
                  {item?.name}
                </span>
                <div className="mt-[12px] flex items-center  justify-start">
                  <span className="text font-poppins text-[19px] font-semibold not-italic leading-[100%] text-textColor">
                    {item?.price}
                  </span>{" "}
