  ...
  return (
    <div>
      <div
        className={
          open
            ? `scroll-wrapper absolute left-40 top-24 z-50  rounded-md bg-[#FFFFFF]  opacity-100 shadow-xl transition-all duration-100`
            : "absolute  left-40 top-24 z-[-100] h-[0]  opacity-0 transition-all duration-300"
        }
      >
        <div className="mb-10">
          <MdClose
